...
part_path_ = 'started_session_2022_11_uuid'
...
def read_day(year,month,day):
    path = f'{part_path_}/year={str(year)}/month={str(month).zfill(2)}/day={str(day).zfill(2)}'
...
part_year_month_days  = (
                     list(zip([2022]*31, [11]*30, range(28,30)))
                     )
